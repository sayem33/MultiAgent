...
Analyzes multi_agent_results.json and generates comprehensive statistics.
...
def load_results(filename: str = "multi_agent_results.json") -> List[Dict]:
...
def main():
    ...
    parser.add_argument('--input', type=str, default='multi_agent_results.json',
                        help='Input results file (default: multi_agent_results.json)')
